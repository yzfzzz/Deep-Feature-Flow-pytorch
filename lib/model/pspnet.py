...
class pspnet_res18(nn.Module):
    def __init__(self, num_classes=19):
        ...
        config_path = '/home/yezifeng/segmentation/structure-guided/IFR/configs/_base_/models/pspnet_r18-d8.py'
...
class pspnet_res101(nn.Module):
    def __init__(self, num_classes=19):
        ...
        config_path = '/home/yezifeng/segmentation/structure-guided/IFR/configs/_base_/models/pspnet_r101-d8.py'
        cfg = Config.fromfile(config_path)
        self.model = build_segmentor(cfg.model, train_cfg=cfg.get('train_cfg'), test_cfg=cfg.get('test_cfg'))
        self.fix_backbone()
